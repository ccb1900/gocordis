...
//
// Plugin frontend modules are NOT configured here: they are ui-client
// components (see ClientModuleComponent) — composition-governed, visible in
// the plugin explorer, removable, honoring the enabled switch.
