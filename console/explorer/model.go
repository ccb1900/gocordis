...
type Plugin struct {
	...
	Capabilities []string
	Controllable bool
	// Config carries the scalar configuration entries of the desired
	// component (flattened, sorted). It is display-only: the Console shows
	// what a plugin is configured with, but mutation stays in the config
	// file + reconciliation path.
